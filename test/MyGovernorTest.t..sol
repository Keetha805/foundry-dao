...
contract MyGovernorTest is Test {
    ...
    uint256 constant MIN_DELAY = 3600; //  1 hour - after a vote passes, you have 1 hour before you can enact
    uint256 constant VOTING_DELAY = 7200; //  HOW MANY BLOCKS till a vote is active
    ...
    function testTwo() public {
        ...
        //2. Vote
        string memory reason = "my reason";
        uint8 support = 1;
        governor.castVoteWithReason(proposalId, support, reason);
        //voting period needs to pass
